              ...
              <div className="flex flex-col h-full">
                ...
                <SheetHeader className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <SheetTitle className="text-xl font-bold text-gray-900">LeadFlow</SheetTitle>
                      <SheetDescription className="text-xs text-gray-500">{user.organizationName}</SheetDescription>
                    </div>
                  </div>
                </SheetHeader>
